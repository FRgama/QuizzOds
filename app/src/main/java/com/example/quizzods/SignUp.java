...
public class SignUp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnConta.setOnClickListener(v -> {
            ...
            // Gerando um salt e o hash da senha
            String salt = PasswordUtils.getSalt();
            String hashedPassword;
            try {
                hashedPassword = PasswordUtils.generateSecurePassword(senhaText, salt);
            } catch (Exception e) {
                Toast.makeText(SignUp.this, "Erro ao gerar a senha segura: " + e.getMessage(), Toast.LENGTH_SHORT).show();
                return;
            }

            // Criando a requisição de cadastro
            UpRequest signUpRequest = new UpRequest(usernameText, emailText, hashedPassword);
